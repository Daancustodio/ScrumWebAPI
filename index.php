...
$app->get(
	'/geradorDAO',
	function(){
		include_once 'libs/GeradorDao/generate.php';
	});

include_once 'Controllers/papelController.php';
include_once 'Controllers/projetoController.php';
include_once 'Controllers/timeController.php';
include_once 'Controllers/tipoTarefaController.php';
include_once 'Controllers/sprintController.php';
include_once 'Controllers/estoriaController.php';
include_once 'Controllers/tarefaController.php';
include_once 'Controllers/tipoTarefaController.php';
include_once 'Controllers/usuarioController.php';
include_once 'Controllers/usuariopapeltimeController.php';
